...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <div align="center">
                <h1 class="mb-0 font-cookie weight-500">Contato Medicina do Trabalho</h1>
                <img src="images/giz-green-long.png" class="img-fluid mt--33" style="width: 380px;height:10px;">
            </div>
                ...
                <form method="POST" action="processar-contato_trabalho.php">
                    ...
                    <div class="d-md-flex justify-content-between flex-column">
                        ...
                        <div class="d-md-flex align-items-center mb-3">
                            ...
                            <input id="endereco" type="text" class="form-control" name="endereco" required placeholder="Digite o endereço da empresa">
                        </div>
                        ...
                        <div class="d-md-flex align-items-center mb-3">
                            <label for="seguro" class="mr-3 mb-0 bg-success pl-2 py-1 text-white" style="width:200px;">
                                Possui serviço de medicina e segurança do trabalho? &nbsp;
                            </label>
                        ...
                        <div class="d-md-flex align-items-center mb-3">
                            <label for="servicos_interesse" class="mr-3 mb-0 bg-success px-2 py-1 text-white" style="width:200px;">
                                Quais serviços lhe interessam?
                            </label>
                            <input id="servicos_interesse" type="text" class="form-control" name="servicos_interesse" required placeholder="Quais serviços lhe interessam?">
                        </div>
